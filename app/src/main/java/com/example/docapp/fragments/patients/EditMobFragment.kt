...
//import kotlinx.android.synthetic.main.fragment_edit_profile.editFN
 ...
 * Use the [EditMobFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class EditMobFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Inflate the layout for this fragment
         val view:View =inflater.inflate(R.layout.fragment_edit_mob, container, false)
        view.editMobBtn.setOnClickListener{
            update()
        }
        setValues()
        return view
    ...
    private fun setValues () {
        dbs.collection("users")
            ...
            .addOnSuccessListener {
                ...
                mobValField.setText(user.mobile, TextView.BufferType.EDITABLE);
